			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<?php echo apply_atomic_shortcode( 'entry_meta', '<div class="entry-meta">' . __( '[entry-terms taxonomy="category" before="Posted in "] [entry-terms taxonomy="post_tag" before="Tagged "]', 'trending' ) . '</div>' ); ?>
