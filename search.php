			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
						...
						<?php echo apply_atomic_shortcode( 'entry_meta', '<div class="entry-meta">' . sprintf( __( '[entry-published] &mdash; %s', 'trending' ), '<code><a href="' . get_permalink() . '">' . get_permalink() . '</a></code>' ) . '</div>' ); ?>
